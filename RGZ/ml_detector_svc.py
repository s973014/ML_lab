...
if __name__ == "__main__":
    ...
    df.to_csv("cnn_features_dataset_svc.csv", index=False)
    ...
    # добавляем вероятности через CalibratedClassifierCV
    ...
    # ---------------- Save model ----------------
    joblib.dump(clf, "cnn_ai_detector_svm.pkl")
    print("Model saved: cnn_ai_detector_svm.pkl")
